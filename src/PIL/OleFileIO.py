...
from __future__ import \
    print_function  # This version of OleFileIO_PL requires Python 2.6+ or 3.x.
...
def filetime2datetime(filetime):
    ...
    return _FILETIME_null_date + datetime.timedelta(
...
class OleMetadata:
    ...
    SUMMARY_ATTRIBS = ['codepage', 'title', 'subject', 'author', 'keywords',
                       ...
                       'total_edit_time',
                       'last_printed', 'create_time', 'last_saved_time',
                       'num_pages',
    ...
    DOCSUM_ATTRIBS = ['codepage_doc', 'category', 'presentation_target',
                      'bytes', 'lines', 'paragraphs',
                      'slides', 'notes', 'hidden_slides', 'mm_clips',
                      'scale_crop', 'heading_pairs', 'titles_of_parts',
                      'manager',
                      'company', 'links_dirty', 'chars_with_spaces', 'unused',
                      'shared_doc',
                      'link_base', 'hlinks', 'hlinks_changed', 'version',
                      'dig_sig',
                      'content_type', 'content_status', 'language',
                      'doc_version']
